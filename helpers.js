$(window).load(function(e){
    ...
    $('.close_search_desk').click(function(){
        console.log("clear");
        $('.mobile_search').fadeOut();
        ...
        if ($(this).val() == ""){
            ...
            if(s_stores !=undefined && s_stores.length > 0){
                ...
                $.each(s_stores, function(i, v){
                    ...
                    $('.search_results_container_m').show();
                });
            }
            if(s_promos != undefined && s_promos.length > 0){
                var h2_promotions = "<h2 id='open_promotions' class='li_open'>(" +s_promos.length + ") Promotions<i class='pull-right fa fa-chevron-down'></i></h2>";
...
function renderSitePopup(){
    ...
    if (pp != undefined){
        if (pp.contest.name != undefined && pp.contest.name.length > 0){
            $('.popup-body').append('<img id="pp_img" class="pp_img_bg" src="//assets.mallmaverick.com' + pp.photo_url + '" alt="pop up">');
            ...
            if (pp.photo_link.length > 0){
                $('.popup-body').html('<a id="pp_url" href="' + pp.photo_link +'"><img id="pp_img" src="//assets.mallmaverick.com' + pp.photo_url + '" alt="pop up"></a>')
            }
            else{
                $('.popup-body').html('<img id="pp_img" src="//assets.mallmaverick.com' + pp.photo_url + '" alt="pop up">')
            }
        }
